...
-k, kraken_file_specifications:
    ...
    match the input file sample names and the Kraken files should 
    correspond to those used for the Bracken files. The order of this
    file does not matter but I find it easiest if the order is the
...
def main():
    ...
    parser.add_argument(
        '-o', '--output_file',
        help='(in PDF format) What do you want to name the output file?',
        metavar='',
        type=str,
        required=True
        )
