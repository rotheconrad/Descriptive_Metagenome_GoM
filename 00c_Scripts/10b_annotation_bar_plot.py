...
def plot_cog_cat(df, outpre, sample_order):
    ...
    adf = adf[sample_order]
    adf.to_csv(f'{outpre}_cog_categories.tsv', sep='\t')
...
def plot_cog_class(df, outpre, sample_order):
    # setup and launch the cog category plot
    ...
    adf = adf[border].T.fillna(0)
    adf = adf[sample_order]
    adf.to_csv(f'{outpre}_cog_classes.tsv', sep='\t')
...
def main():
    ...
    sample_order = [
                    'EN_21', 'EN_51', 'EN_81', 'EN_22', 'EN_52', 'EN_82',
                    'EN_23', 'EN_53', 'EN_83', 'EN_24', 'EN_54', 'EN_84', 
                    'EN_25', 'EN_55', 'EN_85', 'EN_56', 'EN_57', 'EN_58', 
                    'EN_59',
                    ]
    ...
    print('##################################################################')
    _ = plot_cog_cat(df, outpre, sample_order)
    ...
    print('##################################################################')
    _ = plot_cog_class(df, outpre, sample_order)
